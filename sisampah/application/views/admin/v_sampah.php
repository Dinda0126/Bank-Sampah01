...
<head>
    ...
    <title>Management data sampah</title>
    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        ...
                        $id=$a['sampah_id'];
                        $nm=$a['sampah_nama'];
                        $satuan=$a['sampah_satuan'];
                        $harpok=$a['sampah_harpok'];
                        $harjul=$a['sampah_harjul'];
                        $stok=$a['sampah_stok'];
                        $kat_id=$a['sampah_kategori_id'];
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Tambah Sampah</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Sampah</label>
                        <div class="col-xs-9">
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="modal-title" id="myModalLabel">Edit Sampah</h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input name="kobar" class="form-control" type="text" value="<?php echo $id;?>" style="width:335px;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga Pokok</label>
                            <div class="col-xs-9">
                                <input name="harpok" class="harpok form-control" type="text" value="<?php echo $harpok;?>" style="width:335px;" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga Jual</label>
                            <div class="col-xs-9">
                                <input name="harjul" class="harjul form-control" type="text" value="<?php echo $harjul;?>" style="width:335px;" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Stok</label>
                            <div class="col-xs-9">
                                <input name="stok" class="form-control" type="number" value="<?php echo $stok;?>"  style="width:335px;" required>
                            </div>
                        </div>
        ...
        <!-- Footer -->
       <?php 
        $this->load->view('admin/credit_footer');
      ?>
