        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data
                    <small>Nasabah</small>
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Nasabah</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Tambah Nasabah</h3>
                    </div>
