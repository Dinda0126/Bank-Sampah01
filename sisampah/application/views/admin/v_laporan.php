            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Penjualan Sampah</td>
                        <td style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Penjualan Sampah PerTanggal</td>
                        <td style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Penjualan Sampah PerBulan</td>
                        <td style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Penjualan Sampah PerTahun</td>
                        <td style="text-align:center;">
