...
<head>
    ...
    <title>Pembelian - Bank Sampah</title>
        ...
        <div class="row">
            ...
            <table>
                <tr>
                    ...
                    <th style="width:90px;padding-bottom:5px;">Nasabah</th>
                    <td style="width:350px;">
                    <select name="suplier" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Nasabah" data-width="100%" required>
