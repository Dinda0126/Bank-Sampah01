								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<select class="form-control" name="level">
											...
											<option <?php if($p->pengguna_level == "pimpinan"){ echo "selected='selected'";} ?> value="pimpinan">Pimpinan</option>
											<option <?php if($p->pengguna_level == "nasabah"){ echo "selected='selected'";} ?> value="nasabah">Nasabah</option>
										</select>
