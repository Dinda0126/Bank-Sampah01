						...
						<?php foreach($profil as $p){ ?>
							...
							<form method="post" action="<?php echo base_url('dashboard/profil_update') ?>">
								<div class="box-body">
									...
									<div class="form-group">
										<label>No Telp</label>
										<input type="text" name="telp" class="form-control" placeholder="Masukkan No Telp" value="<?php echo $p->pengguna_telp; ?>">
										<?php echo form_error('telp'); ?>
									</div>

									<div class="form-group">
										<label>Alamat</label>
										<input type="text" name="alamat" class="form-control" placeholder="Masukkan Alamat Lengkap" value="<?php echo $p->pengguna_alamat; ?>">
