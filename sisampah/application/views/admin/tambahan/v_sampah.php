					...
					<div class="box-body">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php 
								$no = 1;
								foreach($tbl_sampah as $s){ 
									?>
									<tr>
										<td><?php echo $no++; ?></td>
										<td><?php echo $s->sampah_nama; ?></td>
										<td><?php echo $s->sampah_harpok; ?></td>
										<td><?php echo $s->sampah_kategori_id; ?></td>
										<td><?php echo $s->sampah_user_id; ?></td>
				
										<td>
											<a href="<?php echo base_url().'dashboard/sampah_edit/'.$s->sampah_id; ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pencil"></i> </a>
											<a href="<?php echo base_url().'dashboard/sampah_hapus/'.$s->sampah_id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
