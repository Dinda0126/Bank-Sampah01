...
<head>
    ...
    <meta name="description" content="Sanmediatek">
                ...
                <div class="menu-item color" style="height:150px;">
                     <a href="<?php echo base_url().'admin/kategori'?>" data-toggle="modal">
                           <i class="fa fa-sitemap"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Kategori Sampah</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
                <div class="menu-item purple" style="height:150px;">
                     <a href="<?php echo base_url().'admin/barang'?>" data-toggle="modal">
                           <i class="fa fa-dollar"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Data Sampah</p>
                      </a>
                </div> 
            </div>
            <?php }?>
        ...
        <?php if($h=='1'){ ?> 
            <div class="col-md-3 portfolio-item">
                <div class="menu-item purple" style="height:150px;">
                     <a href="<?php echo base_url().'admin/barang'?>" data-toggle="modal">
                           <i class="fa fa-dollar"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Data Tabungan</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
                ...
                <div class="menu-item light-red" style="height:150px;">
                     <a href="<?php echo base_url().'admin/pembelian'?>" data-toggle="modal">
                           <i class="fa fa-cogs"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Pengaturan</p>
                      </a>
                </div> 
            </div>
            <?php }?>
