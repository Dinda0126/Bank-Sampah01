...
<head>
    ...
    <title>Penjualan - Bank Sampah</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small>Daftar Sampah</small></a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Data Sampah</h3>
            </div>
                  ...
                  <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                    <thead>
                        <tr>
                            ...
                            <th style="width:120px;">Kode Sampah</th>
                            <th style="width:240px;">Nama Sampah</th>
                            <th>Satuan</th>
                            <th style="width:100px;">Harga (Kg)</th>
                            <th>Stok</th>
                            <th style="width:100px;text-align:center;">Aksi</th>
                        </tr>
                    </thead>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2020';?> | Bank Sampah STMIK Nusa Mandiri</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
