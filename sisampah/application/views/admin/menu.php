 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url().'welcome'?>">Bank Sampah</a>
            </div>
                   ...
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url().'admin/penjualan'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Penjualan</a></li> 
                        </ul>
                    </li>
                    <!--ending dropdown-->
                  <!--  <li>
